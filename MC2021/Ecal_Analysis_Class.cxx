...
RNode Ecal_Analysis_Class::extend_dataframe(RNode in){
   ...
   auto lambda_get_score_primary_hits_energy = [this](vector<double> &mc_part_z, vector<int> &mc_score_part_idx, vector<double> &mc_score_z,
   ...
   auto lambda_get_score_secondary_hits_energy = [this](vector<double> &mc_part_z, vector<int> &mc_score_part_idx, vector<double> &mc_score_z,
                                                        vector<double> &mc_score_px, vector<double> &mc_score_py, vector<double> &mc_score_pz){
      return get_score_secondary_hits_energy(mc_part_z, mc_score_part_idx, mc_score_z, mc_score_px, mc_score_py, mc_score_pz);};

   auto lambda_get_score_n_primary_hits = [this](vector<double> &mc_part_z, vector<int> &mc_score_part_idx,
   ...
   auto lambda_get_score_n_secondary_hits = [this](vector<double> &mc_part_z, vector<int> &mc_score_part_idx,
         vector<double> &mc_score_z, vector<double> &mc_score_pz){
...
vector<int> Ecal_Analysis_Class::get_score_n_primary_hits(vector<double> &mc_part_z, vector<int> &mc_score_part_idx,
...
vector<int> Ecal_Analysis_Class::get_score_n_secondary_hits(vector<double> &mc_part_z, vector<int> &mc_score_part_idx,
                                                          vector<double> &mc_score_z, vector<double> &mc_score_pz) const {
   vector<int> out;
   for(size_t i_part=0; i_part < mc_part_z.size(); ++i_part){
      if(abs(mc_part_z[i_part]) >= 1e-6 ){
...
vector<int> Ecal_Analysis_Class::get_centers_of_scored_secondary_mc(vector<double> &part_z, vector<int> &mc_score_part_idx, vector<double> &mc_score_x,
...
vector<double> Ecal_Analysis_Class::get_score_primary_hits_energy(vector<double> &mc_part_z, vector<int> &mc_score_part_idx,
...
vector<double> Ecal_Analysis_Class::get_score_secondary_hits_energy(vector<double> &mc_part_z, vector<int> &mc_score_part_idx,
                                                                  vector<double> &mc_score_z, vector<double> &mc_score_px,
                                                                  vector<double> &mc_score_py, vector<double> &mc_score_pz) {
   vector<double> out;
   for(size_t i_part=0; i_part < mc_part_z.size(); ++i_part){
